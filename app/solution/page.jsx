  ...
  return (
    ...
    <section className="h-screen">
      ...
      <div className="text-white absolute top-20 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-10">
        <h2 className="text-5xl text-center font-bold">La <span className="bg-primary-dark px-1">digitalisation</span> de votre écurie, enfin <span className="underline">abordable</span></h2>
        <p className="text-lg text-center w-3/4 mt-12">Offrez à votre écurie une gestion moderne et abordable grâce à nos écrans e-Ink robustes et personnalisables. La digitalisation ,n'a jamais été aussi accessible !</p>
        <Link href="/tarif">
        ...
        <Image src={hero}  alt="cheval au galop" fill={true} className="object-cover object-top"/>
      </div>
    </section>
