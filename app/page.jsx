...
import JoinSection from "./components/home-page/JoinSection";

// pages/index.js ou pages/home.js
  ...
  try {
    ...
    return (
      <div>
        ...
        <HeroSection
          videoUrl={home.heroSection.videoUrl}
          videoTxt={home.heroSection.btnText}
        />
        <TrustSection />
        <QuoteSection
          testimonial={home.testimonial}
          avatar={process.env.NEXT_PUBLIC_STRAPI_URL + "/api/home/photo"}
        />
      </div>
    );
  } catch (err) {
