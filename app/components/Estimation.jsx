            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-4 text-lg">
                        Fini les ardoises obsolètes et les erreurs : optez pour nos écrans e-Ink robustes
                        et entièrement personnalisables pour une gestion optimale de vos boxes.
                    </p>
                    <div className="mt-6 flex space-x-4">
                        <Link href="/solution">
                            <button className="border border-white px-4 py-2 rounded">En savoir plus</button>
                        </Link>
                        <Link href="/devis">
                            <button className="bg-white text-yellow-800 px-4 py-2 rounded">Demander un devis</button>
                        </Link>
                    </div>
                </div>
                ...
                <div className="flex-[2] flex justify-center items-center ">
                    <div className="flex overflow-hidden rounded-sm border space-x-[1px]">
                        <NumberBox amount={horses} itemType="chevaux" range={handleRange} setItemType={setHorses} />
                        <NumberBox amount={boxes} itemType="boxes" range={handleRange} setItemType={setBoxes} />
